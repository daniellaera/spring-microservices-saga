...
get_color() {
  case $1 in
    ...
    "audit-trail-service")  echo "\033[0;93m" ;;  # bright yellow
    *)                      echo "\033[0m" ;;
  esac
}
...
# Give Docker services time to spin up (longer on fresh start)
sleep 10

# --- 2. Kill Existing Local Services ---
echo "Killing existing local services running on ports..."
for port in 8888 8080 8081 8082 8083 8084 8085 8086 8087 4200; do
...
start_service "audit-trail-service" "local"
...
wait_for_service "http://localhost:8087" "audit-trail-service"
sleep 3
...
echo -e "\033[1;32mMailpit available at: http://localhost:8025\033[0m"
echo -e "\033[1;32mGrafana available at: http://localhost:3000\033[0m"
echo -e "\033[1;32mDozzle available at: http://localhost:9999\033[0m"
